      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3" id="tour-stock-search">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 py-2.5 text-xs font-semibold text-slate-900 outline-none shadow-xs focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
          />
        </div>
