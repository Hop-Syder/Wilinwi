 ...
 * @description Carte KPIs Synthèse Stock Haut de Page (Axe 1)
 * @created 2026-08-03
 * @updated 2026-08-03
...
export function StockKpiCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200/70 bg-white p-5 shadow-sm space-y-3 transition-all hover:shadow-md">
        ...
        <div className="space-y-1.5 font-mono">
          ...
          {canSeeCost && (
            <div className="pt-1 border-t border-slate-100 flex items-center justify-between text-xs">
              <span className="text-slate-500 font-sans font-medium">Prix d'Achat (Capital) :</span>
      ...
      <button
        ...
        className={`relative text-left overflow-hidden rounded-2xl border p-5 shadow-sm transition-all duration-200 ${
          filterLowStockActive
      ...
      <div className="relative overflow-hidden rounded-2xl border border-rose-200/80 bg-rose-50/50 p-5 shadow-sm space-y-3 flex flex-col justify-between">
        <div className="flex items-center justify-between">
